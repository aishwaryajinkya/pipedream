...
export default {
  ...
  name: "Get Reviewers",
  description: "Get reviewers for a PR or Commit SHA. [See docs here](https://docs.github.com/en/rest/commits/commits#list-pull-requests-associated-with-a-commit)",
  version: "0.0.1",
  type: "action",
  props: {
    github,
    ...
    reviewStates: {
      ...
      options: constants.pullRequestStates,
      optional: true,
    },
  },
  methods: {
